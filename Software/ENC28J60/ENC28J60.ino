...
String z = "0", mac_serial = "00:01:02:03:04:05";
char local_ip = "0";
...
static void internet () {
  ...
  if (client.connect("energy-saver.3e-turkey.com", 80)) {
    ...
    client.println("GET /updater.php?v=8VdiCJMubyLAY37sT5Kbvfq8nLlQgznb&serial=" + mac_serial + "&person=" + person + "&e_status=" + e_status + "&power_cut=" + power_cut + "&local_ip=" + local_ip +" HTTP/1.1");
